  ...
  return (
    <div className="legal-containers">
      <div className="legal-container">
        <h1 className="title">Legal Opinion</h1>
      </div>
      ...
      <div className="legal-cards">
        ...
        <div className="legals-card">
          <h1 className="heading">Why Our JURISMAX?</h1>
          <p className="paragraph1">JURISMAX has a profound experience in title due diligence throughout its journey and the dedicated
        ...
        <div className="legals-card">
          ...
          <Link to={"/File"}>
           {/* <button className="button">Document Collection</button> */}
